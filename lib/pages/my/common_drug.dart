        ...
        Row(
          children: <Widget>[
            ...
            Container(
              ...
              child: Text('内科',style: GSYConstant.textStyle(fontSize: 13.0),),
            )
          ],
        ),
        const SizedBox(height: 3.0,),
        Text('口服：一次3粒，4次/天，2盒',style: GSYConstant.textStyle(fontSize: 13.0,color: '#888888'),)
      ],
    ),
  );
}
                ...
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      const SizedBox(width: 3.0,),
                      Text('条常用药品',style: GSYConstant.textStyle(fontSize: 15.0,color: '#666666')),
                    ],
                  ),
                ),
                ListView.builder(
                ...
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Text('操作提示：左滑删除常用药品',style: GSYConstant.textStyle(fontSize: 13.0,color: '#666666'),)
                    ],
                  ),
                )
              ],
          ...
          CustomSafeAreaButton(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Text('添加常用药',style: GSYConstant.textStyle(fontSize: 16.0),)
                ],
              ),
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context)=>AddCommonDrug()));
              })
        ],
      ),
    );
