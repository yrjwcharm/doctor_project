...
class _UseDrugInfoState extends State<UseDrugInfo> {
  final List list =[{'label':'每次用量','placeholder':'请选择频率'},{'label':'次数：','placeholder':'请输入数量 粒/次'},{'label':'用法：','placeholder':'请选择用法'},{'label':'持续用药天数：','placeholder':'请输入用药天数'}];
  @override
        ...
        children: [
          Container(
            ...
            child: Text(
              ...
              style: GSYConstant.textStyle(fontSize: 12.0, color: '#EC605D'),
            ),
          ),
          Container(
          ...
          Container(
            ...
            child: Row(
              crossAxisAlignment:CrossAxisAlignment.start,
              children: <Widget>[
                Text('备注',style: GSYConstant.textStyle(color: '#333333'),),
                  SizedBox(width: 6.0,),
