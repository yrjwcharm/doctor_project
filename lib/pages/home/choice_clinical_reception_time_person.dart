...
class _ChoiceClinicReceptTimePersonState
 ...
 Widget buildComp(){
    return  Padding(padding:const EdgeInsets.only(left: 8.0,bottom: 10.0),child: Row(
      children: <Widget>[
        Container(
          padding: const EdgeInsets.only(left: 8.0,right: 10.0,top: 8.0,bottom: 9.0),
          ...
          child: Row(
            children: <Widget>[
              SizedBox(
                ...
                child:Text('开始时间',style: GSYConstant.textStyle(fontSize:ScreenUtil().setSp(13),color: '#999999'),),
              ),
              const SizedBox(width: 5.0,),
              Text('至',style: GSYConstant.textStyle(color: '#888880',fontSize: ScreenUtil().setSp(14.0)),),
              const SizedBox(width: 7.0,),
              SizedBox(width: ScreenUtil().setWidth(53.0),
                child:Text('结束时间',style: GSYConstant.textStyle(fontSize:ScreenUtil().setSp(13),color: '#999999'),),),
        ...
        Container(
          ...
          child: TextField(
            ...
            style: GSYConstant.textStyle(fontSize:ScreenUtil().setSp(13),color: '#666666'),
            ...
            decoration: InputDecoration(
                ...
                hintStyle: GSYConstant.textStyle(fontSize:ScreenUtil().setSp(13),color: '#333333')
            ),
          ),
        ),
        const SizedBox(width: 10.0,),
            ...
            children: [
              Column(
                  children: list
                      ...
                      .toList()),
              Column(
                children: listComponent.map<Widget>((item) =>item ).toList(),
              ),
            ],
          ),
        ],
